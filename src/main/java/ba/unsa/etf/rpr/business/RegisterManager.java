...
public class RegisterManager {
    public static User addUser(String username, String password, String email, String fullName, String dateOfBirthStr, int roleId) throws Exception, NoSuchAlgorithmException {
